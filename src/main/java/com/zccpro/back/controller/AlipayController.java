...
public class AlipayController {
	...
	@RequestMapping("/createOder.do")
	public String createOder(HttpServletRequest request,Model model){
		String WIDout_trade_no = MyStringUtils.getoder();
		String WIDsubject = "贷信链短信服务充值";
		String WIDtotal_amount = "200";;
		String WIDbody = "贷信链短信充值服务-200元";
	...
	public String alipay(HttpServletRequest request,Model model){
		String parameter = request.getParameter("WIDout_trade_no");
...
//		out.println(result);
	...
	//查询
	@RequestMapping("/alipayquery.do")
	public String alipayquery(HttpServletRequest request,Model model) throws UnsupportedEncodingException, AlipayApiException{
		//获得初始化的AlipayClient
		AlipayClient alipayClient = new DefaultAlipayClient(AlipayConfig.gatewayUrl, AlipayConfig.app_id, AlipayConfig.merchant_private_key, "json", AlipayConfig.charset, AlipayConfig.alipay_public_key, AlipayConfig.sign_type);
	...
	public String notify_url(HttpServletRequest request,Model model) throws UnsupportedEncodingException, AlipayApiException{
		//获取支付宝POST过来反馈信息
	...
	public String return_url(HttpServletRequest request,Model model) throws UnsupportedEncodingException, AlipayApiException{
		//获取支付宝GET过来反馈信息
		Map<String,String> params = new HashMap<String,String>();
		Map<String,String[]> requestParams = request.getParameterMap();
		for (Iterator<String> iter = requestParams.keySet().iterator(); iter.hasNext();) {
