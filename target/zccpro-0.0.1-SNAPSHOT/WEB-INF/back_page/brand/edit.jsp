...
<div class="body-box" style="float:right">
	<form id="jvForm" action="/brand/edit.do" method="post" enctype="multipart/form-data">
			...
			<tbody>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h"></td>
						<td width="80%" class="pn-fcontent">
						<img width="100" height="100" id="url" src="${brand.webSite }"/>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<input type="radio" name="isDisplay" value="1" checked="checked" value="${brand.isDisplay}"/>可用
